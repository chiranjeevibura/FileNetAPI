...
public class DeleteDocumentsByClass {
    public static void main(String[] args) {
        ...
        try {
            ...
            FileInputStream fileInputStream = new FileInputStream("C:\\Work\\fnuatc.crt");
...
private static void deleteDocumentObjects(Connection connection, String className) {
	try {
		...
		UserContext.get().pushSubject(UserContext.createSubject(connection, "p8padmin", "p8fnadm", "FileNetP8WSI" ));
		...
		System.out.println("Error deleting document objects: " + e.getMessage());
		e.printStackTrace();
	} finally {
		UserContext.get().popSubject();
	}
