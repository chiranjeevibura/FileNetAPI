...
public class PropertyTemplateSync {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            List<String> sourcePropertyTemplates = getPropertyTemplates(sourceDomain, sourceObjectStore);
            System.out.println("Property Templates in Object Store: " + sourcePropertyTemplates);
            List<String> targetPropertyTemplates = getPropertyTemplates(targetDomain, targetObjectStore);
            System.out.println("Property Templates in Object Store: " + targetPropertyTemplates);
			...
			// Generate a report
			generateReport(missingPropertyTemplates);
	...
	private static List<String> getPropertyTemplates(Domain domain, ObjectStore sourceObjectStore) {
		...
		try {
	        ...
	        while (templateIterator.hasNext()) {
	            ...
	            System.out.println("Proeprty Template in Object Store: " + ptml.g
	    	      }
	...
	private static void generateReport(List<String> missingPropertyTemplates) {
