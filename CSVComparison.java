...
public class CSVComparison {
    public static void main(String[] args) {
        String inputCsvFile1 = "input1.csv";
        String inputCsvFile2 = "input2.csv";
        ...
        try {
            ...
            Set<String> uniqueRecords = mergeSortedChunks(sortedChunks1, sortedChunks2, columnToCompare);
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(inputFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (chunk.size() >= chunkSize) {
                    Collections.sort(chunk, new CSVComparator(columnToCompare));
    ...
    private static Set<String> mergeSortedChunks(List<String> sortedChunks1, List<String> sortedChunks2, String columnToCompare) {
        Set<String> uniqueRecords = new ConcurrentSkipListSet<>(new CSVComparator(columnToCompare));
        ...
        while (record1 != null && record2 != null) {
            int compareResult = new CSVComparator(columnToCompare).compare(record1, record2);
            if (compareResult < 0) {
    ...
    private static void writeUniqueRecordsToCSV(Set<String> uniqueRecords, String outputFile) throws IOException {
    ...
    static class CSVComparator implements Comparator<String> {
        ...
        CSVComparator(String columnToCompare) {
        ...
        public int compare(String record1, String record2) {
            ...
            int columnIndex = getColumnIndex(fields1, columnToCompare);

            return fields1[columnIndex].compareTo(fields2[columnIndex]);
        }

        private int getColumnIndex(String[] fields, String columnName) {
